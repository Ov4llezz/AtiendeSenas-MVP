"""
test_v2.py - Evaluación de modelo VideoMAE V2 (Train+Val Combinados)

Autor: Rafael Ovalle - Tesis UNAB
Dataset: WLASL100_V2/WLASL300_V2 (test set usado como validación)
...
NOTA: En V2, el test set se usa tanto para validación durante entrenamiento
      como para evaluación final.
"""
...
DEFAULT_CONFIG = {
    ...
    "base_path": r"C:/Users/ov4ll/Desktop/TESIS/AtiendeSenas-MVP/data/WLASL_v0.3",
    "batch_size": 4,  # Reducido para GTX 1660 Super (6GB VRAM)
    "num_workers": 2,  # Optimizado para GPU local
    "device": "cuda" if torch.cuda.is_available() else "cpu",
    "output_dir": "evaluation_results_v2",  # Resultados separados
    "top_k": [1, 3, 5],  # Top-K accuracy
    "checkpoint_dir": r"C:/Users/ov4ll/Desktop/TESIS/AtiendeSenas-MVP/models/v2/wlasl100_v2/checkpoints",
...
def evaluate_model(
    ...
    for videos, labels in progress_bar:
        ...
        # Limpiar memoria GPU para evitar OOM
        if device == "cuda":
...
def main(args):
    ...
    elif config["base_path"] == "data/wlasl100_v2" and num_classes == 300:
        config["base_path"] = "data/wlasl300_v2"

    # Detectar si es V2 basándose en el base_path
    is_v2 = "_v2" in config["base_path"]
    if is_v2:
        dataset_label = "WLASL300-V2" if num_classes == 300 else "WLASL100-V2"
    else:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="[V2] Evaluación VideoMAE - Train+Val Combinados - WLASL100/300",
    ...
    parser.add_argument("--checkpoint_dir", type=str, default=DEFAULT_CONFIG["checkpoint_dir"],
                        help="Directorio donde están los runs V2")

    # Dataset
    parser.add_argument("--base_path", type=str, default=DEFAULT_CONFIG["base_path"],
                        help="Ruta base del dataset WLASL100_V2")
